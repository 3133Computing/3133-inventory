...
return [
    ...
    'rapid_intake' => 'Rapid Intake',
    'rapid_intake_help' => 'Scan or type a barcode, enter the quantity and storage location, then press Enter to add stock. Unknown barcodes create a basic stock item automatically.',
    'rapid_intake_name_help' => 'Leave blank for known items. For a new barcode, use free lookup to auto-fill a title or leave blank to default to the barcode.',
    'barcode_lookup_button' => 'Lookup title',
    'barcode_lookup_searching' => 'Looking up barcode title...',
    'barcode_lookup_found' => 'Found title from :source.',
    'barcode_lookup_not_found' => 'No free barcode title found. You can type a name or leave it blank.',
    'barcode_lookup_duplicate_existing' => 'Existing item matched: :item. Receiving will add to this stock record.',
    'barcode_lookup_not_found_create_basic' => 'No barcode title found. Receiving will create a basic stock item.',
    'barcode_lookup_failed' => 'Barcode lookup failed. You can still receive stock manually.',
    'barcode_lookup_free_source' => 'free lookup',
    'dashboard_sellable_stock_focus' => 'Sellable stock first',
    'dashboard_sellable_stock_focus_help' => 'Use Rapid Intake for warehouse receiving, the top barcode search for sellable stock lookup, and Loaners / Assets only for checkout equipment.',
    'lookup_by_sellable_stock_barcode' => 'Lookup Sellable Stock Barcode',
    'sellable_stock_barcode_not_found' => 'No sellable stock item found for barcode :barcode.',
    'rapid_intake_fast_flow' => 'Fast warehouse flow',
    'rapid_intake_step_scan' => 'Scan barcode.',
    'rapid_intake_step_quantity' => 'Type quantity.',
    'rapid_intake_step_location' => 'Type or pick storage location.',
    'rapid_intake_step_enter' => 'Press Enter.',
    'rapid_intake_existing_new_help' => 'Existing barcodes receive stock. New barcodes create sellable stock in “Uncategorized Stock”.',
    'rapid_intake_log_note' => 'Rapid intake to :location',
    'rapid_intake_success' => 'Added :quantity × :item to :location.',
    'rapid_intake_location_help' => 'Required. Use office bins, tool bag, tool chest, office drawers, garage, other, or any existing storage area.',
    'storage_location' => 'Storage Location',
    'last_10_received_items' => 'Last 10 received items',
    'no_recent_received_items' => 'No received stock yet.',
    'move_stock' => 'Move Stock',
    'move_stock_log_note' => 'Moved stock to :location',
    'move_stock_success' => 'Moved :item to :location.',
    ...
    'stock_remove_too_many' => 'You cannot remove more stock than is currently available.',
    ...
    'dashboard_info' => '3133 Inventory at a glance.',
    '60_percent_warning' => '60% Complete (warning)',
    'dashboard_empty' => 'Start by adding loaner assets, sellable stock, customers, or scanning inventory barcodes.',
    'new_asset' => 'New Asset',
